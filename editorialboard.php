								...
								<div id="sj-content" class="sj-content">
									<div class="sj-articledetail">
										...
										<div class="col-md-12">
                                         ...
                                         <div class="col-md-12 content-e"  style='padding:20px;max-height:1000px;overflow:scroll; overflow-x: hidden;'>
                                          	   <?php
												...
												$stmt = $conn->query($sql);
												$num_rows = $conn->executeQuery($sql)->rowCount();
												if($num_rows==0){
													continue;
												}
												?>
												<h4 style='font-size:20px;color:#0071ff'><?=$row2['category']?></h4>
												<?php
