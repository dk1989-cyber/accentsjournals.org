  ...
  $finalResponse = json_decode($receiveData, true);
     if($finalResponse['success']){
        ...
        if($conn->insert('feedback',$data)){      
          ...
          header("refresh:0;url='../feedback.php?success=1&msg=Feedback Successfully Sent to Admin'");      
        }
        else{
          header("refresh:0;url='../feedback.php?success=0&msg=Validation Failed'");    
        }
     }
    }
     else{
      header("refresh:0;url='../feedback.php?success=0&msg=Please Try Again. Validation Failed'");    
     }
