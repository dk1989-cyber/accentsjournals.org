                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$purpose?></td>
                                    <td>
                                    <a onclick="delete_e_alert(<?=$email_alert_id?>);"  class='btn btn-danger btn-sm'><i class='fa fa-times'></i></a></td>
                                </tr>
                            <?php
                            $i=$i+1;
                            }
...
<script>
    function delete_e_alert(id){
  if(confirm("Are you sure")){
       burl="../action/deleteAction.php"; 
       $.post(burl,{"id":id,"tab":"email"},function(data,status){
