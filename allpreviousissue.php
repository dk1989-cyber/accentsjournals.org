					      ...
					      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                   ...
                                   <div class="sj-issuesweeks">
                                     <div id="sj-accordion" class="sj-accordion" role="tablist" aria-multiselectable="true">
										 <?php
                                         // $q="select year,volume,issue_id from issue where journals_id='$journalsId' and status='previous' group by volume  order by issue_id desc";
                                          ...
                                          <div class="sj-panel">
                                                    ...
                                                    <div class="sj-panelcontent">
                                                           ...
                                                           <div class="sj-recordholder">
                                                            <?php
                                                                $q2="select * from issue where year='$year' and journals_id='$journals_id' and status='previous' order by issue_id desc ";
                                                                $stmt2 = $conn->query($q2);
                                                                while(($row2=$stmt2->fetchAssociative())!==false){
                                                                extract($row2);
                                                               ?>
                                                                <a class="sj-btnrecord" href="previousIssue.php?issueId=<?=$issue_id?>&journalsId=<?=$journals_id?>"><span>ISSUE <?=$issue?></span><i class="fa fa-angle-right"></i></a>
                                                               <?php
                                                                }
                                                             ?>
                                                            </div>
